...
// BOP
recipes.remove(<biomesoplenty:mud_sword>);
...
recipes.remove(<mysticalagriculture:supremium_sword_strength1>);
recipes.remove(<mysticalagriculture:supremium_sword_strength2>);
recipes.remove(<mysticalagriculture:supremium_sword_aoe>);
...
// BOP SHOVELS
recipes.remove(<biomesoplenty:mud_shovel>);
...
recipes.remove(<mysticalagriculture:supremium_shovel_aoe>);

// THERMAL FOUNDATION SHOVELS
